...
/***/ function(module, exports) {
	...
	var didXWin = function didXWin(tray) {
	  var lanes = getLanes(tray);
	  return lanes.indexOf('xxx') > -1;
	};

	var didOWin = function didOWin(tray) {
	  var lanes = getLanes(tray);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getTtlGamesWon = function getTtlGamesWon(games) {
	  ...
	  allGamesWon = getTtlGamesFinished(games).filter(function (e) {
	    return winLogic.didXWin(e.cells);
	  });
	  return allGamesWon;
	};

	var getTtlGamesTied = function getTtlGamesTied(games) {
	  var allGamesTied = [];
	  allGamesTied = getTtlGamesFinished(games).filter(function (e) {
	...
	var getTtlGamesLost = function getTtlGamesLost(games) {
	  ...
	  allGamesLost = getTtlGamesFinished(games).filter(function (e) {
	    return winLogic.didOWin(e.cells);
	  });
	  return allGamesLost;
	};
